...
export const Experience = () => {
  ...
  //-math.pi/2 -> right
    ...
    airplane.current.quaternion.slerp(targetCameraQuaternion,delta*2)
  ...
  return (
    <>
      ...
      <group position={[-3,0,-20]}>
        <Text color="white" anchorX={"left"} anchorY={"middle"} fontSize={0.2} maxWidth={2.5} font={"./fonts/Inter/static/Inter_18pt-Regular.ttf"}>
